                    ...
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white mb-4">All Departure Bookings</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-box dashboard-card">
                            <div class="form-title-wrap">
                                <div class="d-flex justify-content-between">
                                    <h3 class="title">Latest Booking Entries (Today Departure = <b>{{todayDeparture()}}</b>)</h3>
                                    <a href="{{ route('admin.export.booking') }}" class="btn btn-primary">Export Departure Bookings</a>
                                </div>
                            </div>
