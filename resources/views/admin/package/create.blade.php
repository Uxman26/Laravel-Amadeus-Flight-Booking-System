                        ...
                        <div class="col-12 responsive-column--m">
                            <div class="form-box dashboard-card">
                                <div class="form-title-wrap">
                                    <div class="">
                                        <h3 class="title">Create Package</h3>
                                    </div>
                                </div>
                                        ...
                                        <form action="{{ route('admin.package.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="mecca_hotel" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="image">Madina Hotel</label>
                                                    <input type="text" name="madina_hotel" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="image">Single Room Price</label>
                                                    <input type="number" name="single_room_price" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="image">Double Room Price</label>
                                                    <input type="number" name="double_room_price" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="image">Triple Room Price</label>
                                                    <input type="number" name="triple_room_price" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="image">Quadruple Room Price</label>
                                                    <input type="number" name="quadruple_room_price" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="numbe" name="infant_price" class="form-control" required>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="file" accept="image/png, image/jpeg, image/jpg" name="image" class="form-control" required>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="image">Description</label>
                                                    <textarea class="form-control" style="width:100%" id="description" name="description"></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
