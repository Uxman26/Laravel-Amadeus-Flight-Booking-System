            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2 float-right mt-3">
                        <form action="{{ route('admin.dashboard.index') }}" id="form">
                        ...
                        <div class="icon-box icon-layout-2 dashboard-icon-box">
                            <div class="d-flex">
                                ...
                                <div class="info-content">
                                    ...
                                    <h4 class="info__title">{{ bookedBookings() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="icon-box icon-layout-2 dashboard-icon-box">
                            <div class="d-flex">
                                ...
                                <div class="info-content">
                                    ...
                                    <h4 class="info__title">{{ issuedBookings() }}</h4> 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="icon-box icon-layout-2 dashboard-icon-box">
                            <div class="d-flex">
                                ...
                                <div class="info-content">
                                    ...
                                    <h4 class="info__title">{{ cancelBookings() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="icon-box icon-layout-2 dashboard-icon-box">
                            <div class="d-flex">
                                ...
                                <div class="info-content">
                                    ...
                                    <h4 class="info__title">{{ todayDeparture() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-12 responsive-column-m">
                        <div class="icon-box icon-layout-2 dashboard-icon-box">
                            <div class="d-flex">
                                ...
                                <div class="info-content">
                                    <p class="info__desc">Sale Percentage</p>
                                    <h4 class="info__title">{{ salePercentage() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
